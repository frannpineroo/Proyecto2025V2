...
namespace Proyecto2025.Server.Controllers
{
    ...
    public class ChatsController : ControllerBase
    {
        ...
        private readonly IRepositorio<Chats> repositorio;

        public ChatsController(AppDbContext context,
                              IRepositorio<Chats> repositorio)
        ...
        public async Task<ActionResult<List<ListaChatsDTO>>> GetChatslista(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Put(int id, Chats DTO)
        {
            if (id != DTO.Id)
            {
        ...
        public async Task<ActionResult<Chats>> GetChatByName(string Name)
        {
        ...
        public async Task<ActionResult<List<Chats>>> GetChatsByGroupStatus(bool IsGroup)
        {
        ...
        public async Task<ActionResult<List<Chats>>> GetChatsByModerationStatus(bool IsModerated)
        {
        ...
        public async Task<ActionResult<List<Chats>>> GetChatsByCreationDate(DateTime CreatedAt)
        {
        ...
        public async Task<ActionResult<List<Chats>>> GetChatsByUpdateDate(DateTime UpdatedAt)
        {
